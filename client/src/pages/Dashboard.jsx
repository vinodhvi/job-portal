      ...
      <div className='shadow py-4'>
       ...
       <img onClick={e => navigate('/')} className="max-sm:w-32 cursor-pointer" src={assets.logo} alt='logo' />
        <div className='flex items-center gap-3'>
          <p className='max-sm:hidden'>Welcome, Developer</p>
          <div className='relative group'>
          <img className='w-8 border rounded-full' src={assets.company_icon} alt='logo' />
      ...
      <div className='flex items-start'>
        ...
        <div className='inline-block min-h-screen border-r-2'>
          <ul className='flex flex-col items-start pt-5 text-gray-800'>
            ...
            >
              <img className='min-w-4' src={assets.home_icon} alt='add' />
            ...
            >
              <img className='min-w-4' src={assets.person_tick_icon} alt='add' />
